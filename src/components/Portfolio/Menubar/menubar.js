...
export function Menubar(){
    return(
        <>
        <nav className="navbar navbar-expand-lg bg-body-tertiary fixed-top menubar-bg m-2">
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
                    <ul className="navbar-nav fw-semibold my-2 text-center">
                        ...
                        <Linkscroll activeClass="active" to="/" spy={true} smooth={true} duration={300} className="menu-item"><li className="nav-item ps-4">Work</li></Linkscroll>
                        ...
                        <Linkscroll activeClass="active" to="https://drive.google.com/file/d/1DN_Hi9LMgqoCrMZb6IO4ApoSshh3lb9u/view?usp=share_link" spy={true} smooth={true} className="menu-item"><li className="nav-item ps-4 d-block d-lg-none">Resume</li></Linkscroll>
                    </ul>
                </div>
                <Link to="https://drive.google.com/file/d/1DN_Hi9LMgqoCrMZb6IO4ApoSshh3lb9u/view?usp=share_link" className="menu-item"><button type="button" class="btn btn-resume rounded-0 me-4 d-none d-lg-block">Resume</button></Link>
            </div>
        </nav>
        </>
    );
