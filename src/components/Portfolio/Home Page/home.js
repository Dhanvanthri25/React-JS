...
export function Home(){
    return(
        <>
        <div className="container justify-center text-center py-5">
            <p className="normal-text mt-5">LET'S BUILD SOMETHING TOGETHER</p>
            <h1 className="py-4 head-text">Hi, I'm <span className="spname">Udhaya Abisheik</span></h1>
            <h1 className="py-2 head-text">A Full Stack Web Developer</h1>
            <p className="normal-text py-4">I'm focused on building responsive fullstack web applications while learning & exploring other technologies.</p>
