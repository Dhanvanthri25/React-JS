    ...
    return(
        ...
        <div className="container row mx-auto p-5">
            <div className="col-lg-8">
                ...
                <button type="button" class="btn btn-primary rounded-0">Check Out My Project <FontAwesomeIcon icon={faArrowRight}/></button>
            </div>
            <div className="col-lg-4">
                <div className="p-4 my-5 shadow-lg rounded-4 img-pop">
